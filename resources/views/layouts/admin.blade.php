  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <small class="bg-pink">Online</small>
                  <span class="hidden-xs">Cindy Morales</span>
                </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2021 <a href="#">detallesmh.com</a>. CindyMorales|AndreaRodas</strong> All rights reserved.
      </footer>
